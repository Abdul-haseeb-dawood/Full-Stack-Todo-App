"""
Final Working Gemini Agent for handling user queries using the Google Gemini API.
...
class GeminiAgent:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        # Define available tools for the agent - using the same format as the working chatbot
        import sys
        import os
...
async def example_usage():
    ...
    print("\nFinal Working GeminiAgent with gemini-2.5-flash model initialized successfully!")
